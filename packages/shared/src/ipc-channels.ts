export const IPC = {
  ...
  BUSINESS_PLAN_GET_CURRENT: "business-plan:get-current",
  BUSINESS_PLAN_APPROVE: "business-plan:approve",
  BUSINESS_PLAN_REJECT: "business-plan:reject",
  ...
  SKILL_PROPOSALS_LIST: "skill-proposals:list",
  SKILL_PROPOSAL_ACCEPT: "skill-proposals:accept",
  SKILL_PROPOSAL_REJECT: "skill-proposals:reject",
  ...
  CONNECTIONS_EMAIL_STATUS: "connections:email-status",
  CONNECTIONS_EMAIL_CONNECT: "connections:email-connect",
  CONNECTIONS_EMAIL_DISCONNECT: "connections:email-disconnect",
} as const;
