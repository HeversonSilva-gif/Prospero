-- 0054_inbox_sale.sql — P5.3. The first real Stripe payment surfaces as a
-- celebratory inbox card (the R$10 proof made visible). SQLite cannot ALTER a CHECK
-- constraint — recreate inbox_items adding the 'sale' kind (same pattern as
-- 0044/0048/0051: defer_foreign_keys + create-new/copy/drop/rename).
